#
#  Be sure to run `pod spec lint MTGoodsDetail.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
		   This is My MTGoodsDetail
                   DESC

  s.homepage     = "https://github.com/mantou811/MTGoodsDetail"
 ...
 # s.license      = "MIT (example)"
  ...
  s.source_files  = "MTGoodsDetail/MTGoodsDetail/**/*.{h,m}"
